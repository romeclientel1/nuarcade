...
For full setup and day-to-day instructions, see the **[Owner's Manual](USER_MANUAL.md)**, verified against Vespara 6.0.4.
...
- **[Owner's Manual](USER_MANUAL.md)** — the full guide, from a guest's quick start to owner setup, verified against Vespara 6.0.4.
