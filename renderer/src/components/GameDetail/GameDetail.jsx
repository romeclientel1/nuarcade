          ...
          <div className={styles.infoSide}>
            ...
            <div className={styles.exeSection}>
              ...
              <div className={styles.exeBox}>
                TeknoParrotUi.exe --profile=<span style={{ color: colors.accent }}>{game.profile}</span>
              </div>
            </div>

            {game.exePath && (
              <div className={styles.exeSection}>
                <div className={styles.exeLabel}>Executable</div>
                <div className={styles.exeBox}>{game.exePath}</div>
              </div>
            )}

            <div className={styles.controlsSection}>
              <div className={styles.exeLabel}>Controls</div>
