...
test("representative Home strings switch between locales", () => {
  ...
  assert.equal(translate("en", "home.statusNone"), "None yet")
  assert.equal(translate("en", "home.statusReady"), "Ready")
  assert.equal(translate("en", "home.statusEmpty"), "Empty")
  assert.equal(translate("es", "home.statusNone"), "Aún no hay")
  assert.equal(translate("es", "home.statusReady"), "Lista")
  assert.equal(translate("es", "home.statusEmpty"), "Vacía")
