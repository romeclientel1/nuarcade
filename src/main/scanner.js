...
const RA_SYSTEM_MAP = {
  ...
  'n64':          { label: 'N64',        genre: 'Platformer', icon: 'N64', exts: ['.n64','.z64','.v64','.ndd'] },
  'gba':          { label: 'GBA',   genre: 'Platformer', icon: 'GBA', exts: ['.gba','.agb'] },
  'gbc':          { label: 'GBC',     genre: 'Platformer', icon: 'GBC', exts: ['.gbc','.gb'] },
  'gb':           { label: 'GB',           genre: 'Platformer', icon: 'GBY', exts: ['.gb','.gbc'] },
  'nds':          { label: 'NDS',        genre: 'Platformer', icon: 'NDS', exts: ['.nds','.dsi'] },
  ...
  // Sega
  'genesis':      { label: 'Genesis',       genre: 'Platformer', icon: 'GEN', exts: ['.md','.gen','.bin','.smd'] },
  ...
  'atarijaguar':  { label: 'Jaguar',       genre: 'Action',     icon: 'JAG', exts: ['.j64','.jag','.rom'] },
  'atarilynx':    { label: 'Lynx',         genre: 'Platformer', icon: 'LYX', exts: ['.lnx','.o'] },
  // NEC
  ...
  'fba':          { label: 'FBA',   genre: 'Fighting',   icon: 'FBA', exts: ['.zip','.7z'] },
  // Other
  ...
  'amstradcpc':   { label: 'CPC',        genre: 'Classic',    icon: 'CPC', exts: ['.dsk','.cdt'] },
  'zxspectrum':   { label: 'ZX Spectrum',        genre: 'Classic',    icon: 'ZXS', exts: ['.tap','.tzx','.z80','.sna'] },
  'c64':          { label: 'C64',       genre: 'Classic',    icon: 'C64', exts: ['.d64','.t64','.prg','.crt'] },
