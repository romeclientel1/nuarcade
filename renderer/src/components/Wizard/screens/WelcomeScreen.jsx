...
const STEPS = [
  ...
  { num: '3', label: 'Paths',       desc: 'Point Vespara to your emulator and game folders on the F: drive.'   },
  { num: '4', label: 'Controllers', desc: 'Map your racing wheel, light gun, and Xbox controller.'               },
  { num: '5', label: 'Scan',        desc: 'Vespara scans your folders and builds your game library.'            },
  ...
  return (
    <div className={styles.screen}>
      ...
      <div className={styles.sub}>
        This wizard configures Vespara in about 5 minutes.
